...
public class Cards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button quitButton = (Button) findViewById(R.id.button36);
        final Button saveButton = (Button) findViewById(R.id.button27);
        final Button deleteButton = (Button) findViewById(R.id.button34);
        final Button backButton = (Button) findViewById(R.id.button37);
