    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (lang){
            ...
            case (10):
                ...
                break;
            case (11):
                tv.setText("अनुवाद चुनें");
                righttv.setText("सही");
                failtv.setText("गलत");
                break;
            case (12):
                tv.setText("اختر ترجمة");
                righttv.setText("حق");
                failtv.setText("خاطئ");
                break;
        }
